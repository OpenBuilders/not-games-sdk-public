...
const file_common_pagination_proto_rawDesc = "" +
	"\n" +
	"\x17common/pagination.proto\x12\tcommon.v1\"P\n" +
	"\n" +
	"Pagination\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x03R\x05total\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\x12\x16\n" +
	"\x06offset\x18\x03 \x01(\x03R\x06offsetBAZ?github.com/OpenBuilders/not-games-sdk-public/gen/grpc/go/commonb\x06proto3"
