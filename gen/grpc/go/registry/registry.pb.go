...
type DeleteItemDefRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ItemDefId     string                 `protobuf:"bytes,1,opt,name=item_def_id,json=itemDefId,proto3" json:"item_def_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *DeleteItemDefRequest) Reset() {
	*x = DeleteItemDefRequest{}
	mi := &file_registry_registry_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteItemDefRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteItemDefRequest) ProtoMessage() {}

func (x *DeleteItemDefRequest) ProtoReflect() protoreflect.Message {
	mi := &file_registry_registry_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteItemDefRequest.ProtoReflect.Descriptor instead.
func (*DeleteItemDefRequest) Descriptor() ([]byte, []int) {
	return file_registry_registry_proto_rawDescGZIP(), []int{17}
}

func (x *DeleteItemDefRequest) GetItemDefId() string {
	if x != nil {
		return x.ItemDefId
	}
	return ""
...
type DeleteItemDefResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        string                 `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *DeleteItemDefResponse) Reset() {
	*x = DeleteItemDefResponse{}
	mi := &file_registry_registry_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteItemDefResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteItemDefResponse) ProtoMessage() {}

func (x *DeleteItemDefResponse) ProtoReflect() protoreflect.Message {
	mi := &file_registry_registry_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteItemDefResponse.ProtoReflect.Descriptor instead.
func (*DeleteItemDefResponse) Descriptor() ([]byte, []int) {
	return file_registry_registry_proto_rawDescGZIP(), []int{18}
}

func (x *DeleteItemDefResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_registry_registry_proto_rawDesc = "" +
	...
	"pagination\x18\x02 \x01(\v2\x15.common.v1.PaginationR\n" +
	"pagination\"6\n" +
	"\x14DeleteItemDefRequest\x12\x1e\n" +
	"\vitem_def_id\x18\x01 \x01(\tR\titemDefId\"/\n" +
	"\x15DeleteItemDefResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2\xe4\x06\n" +
	...
	"\x14UpdateAchievementDef\x12(.registry.v1.UpdateAchievementDefRequest\x1a).registry.v1.UpdateAchievementDefResponse\"\x00\x12X\n" +
	"\rDeleteItemDef\x12!.registry.v1.DeleteItemDefRequest\x1a\".registry.v1.DeleteItemDefResponse\"\x00\x12U\n" +
...
var file_registry_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_registry_registry_proto_goTypes = []any{
	...
	(*DeleteItemDefRequest)(nil),         // 17: registry.v1.DeleteItemDefRequest
	(*DeleteItemDefResponse)(nil),        // 18: registry.v1.DeleteItemDefResponse
	(common.Rarity)(0),                   // 19: common.v1.Rarity
	(*common.FilterTagList)(nil),         // 20: common.v1.FilterTagList
	(*common.Pagination)(nil),            // 21: common.v1.Pagination
}
var file_registry_registry_proto_depIdxs = []int32{
	19, // 0: registry.v1.ItemDef.rarity:type_name -> common.v1.Rarity
	...
	19, // 4: registry.v1.ListItemDefsRequest.rarity:type_name -> common.v1.Rarity
	20, // 5: registry.v1.ListItemDefsRequest.tags:type_name -> common.v1.FilterTagList
	0,  // 6: registry.v1.ListItemDefsResponse.items:type_name -> registry.v1.ItemDef
	21, // 7: registry.v1.ListItemDefsResponse.pagination:type_name -> common.v1.Pagination
	2,  // 8: registry.v1.ListAchievementsDefsResponse.items:type_name -> registry.v1.AchievementDef
	21, // 9: registry.v1.ListAchievementsDefsResponse.pagination:type_name -> common.v1.Pagination
	...
	17, // 16: registry.v1.RegistryService.DeleteItemDef:input_type -> registry.v1.DeleteItemDefRequest
	13, // 17: registry.v1.RegistryService.ListItemDefs:input_type -> registry.v1.ListItemDefsRequest
	15, // 18: registry.v1.RegistryService.ListAchievementsDefs:input_type -> registry.v1.ListAchievementsDefsRequest
	0,  // 19: registry.v1.RegistryService.GetItemDef:output_type -> registry.v1.ItemDef
	6,  // 20: registry.v1.RegistryService.CreateItemDef:output_type -> registry.v1.CreateItemDefResponse
	7,  // 21: registry.v1.RegistryService.UpdateItemDef:output_type -> registry.v1.UpdateItemDefResponse
	2,  // 22: registry.v1.RegistryService.GetAchievementDef:output_type -> registry.v1.AchievementDef
	10, // 23: registry.v1.RegistryService.CreateAchievementDef:output_type -> registry.v1.CreateAchievementDefResponse
	12, // 24: registry.v1.RegistryService.UpdateAchievementDef:output_type -> registry.v1.UpdateAchievementDefResponse
	18, // 25: registry.v1.RegistryService.DeleteItemDef:output_type -> registry.v1.DeleteItemDefResponse
	14, // 26: registry.v1.RegistryService.ListItemDefs:output_type -> registry.v1.ListItemDefsResponse
	16, // 27: registry.v1.RegistryService.ListAchievementsDefs:output_type -> registry.v1.ListAchievementsDefsResponse
