...
const (
	...
	RegistryService_DeleteItemDef_FullMethodName        = "/registry.v1.RegistryService/DeleteItemDef"
	RegistryService_ListItemDefs_FullMethodName         = "/registry.v1.RegistryService/ListItemDefs"
	RegistryService_ListAchievementsDefs_FullMethodName = "/registry.v1.RegistryService/ListAchievementsDefs"
)
...
type RegistryServiceClient interface {
	...
	DeleteItemDef(ctx context.Context, in *DeleteItemDefRequest, opts ...grpc.CallOption) (*DeleteItemDefResponse, error)
	ListItemDefs(ctx context.Context, in *ListItemDefsRequest, opts ...grpc.CallOption) (*ListItemDefsResponse, error)
	ListAchievementsDefs(ctx context.Context, in *ListAchievementsDefsRequest, opts ...grpc.CallOption) (*ListAchievementsDefsResponse, error)
}
...
func (c *registryServiceClient) DeleteItemDef(ctx context.Context, in *DeleteItemDefRequest, opts ...grpc.CallOption) (*DeleteItemDefResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteItemDefResponse)
	err := c.cc.Invoke(ctx, RegistryService_DeleteItemDef_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryServiceClient) ListItemDefs(ctx context.Context, in *ListItemDefsRequest, opts ...grpc.CallOption) (*ListItemDefsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListItemDefsResponse)
	err := c.cc.Invoke(ctx, RegistryService_ListItemDefs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryServiceClient) ListAchievementsDefs(ctx context.Context, in *ListAchievementsDefsRequest, opts ...grpc.CallOption) (*ListAchievementsDefsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListAchievementsDefsResponse)
	err := c.cc.Invoke(ctx, RegistryService_ListAchievementsDefs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegistryServiceServer interface {
	...
	DeleteItemDef(context.Context, *DeleteItemDefRequest) (*DeleteItemDefResponse, error)
	ListItemDefs(context.Context, *ListItemDefsRequest) (*ListItemDefsResponse, error)
	ListAchievementsDefs(context.Context, *ListAchievementsDefsRequest) (*ListAchievementsDefsResponse, error)
...
func (UnimplementedRegistryServiceServer) CreateAchievementDef(context.Context, *CreateAchievementDefRequest) (*CreateAchievementDefResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateAchievementDef not implemented")
}
func (UnimplementedRegistryServiceServer) UpdateAchievementDef(context.Context, *UpdateAchievementDefRequest) (*UpdateAchievementDefResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateAchievementDef not implemented")
}
func (UnimplementedRegistryServiceServer) DeleteItemDef(context.Context, *DeleteItemDefRequest) (*DeleteItemDefResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteItemDef not implemented")
}
func (UnimplementedRegistryServiceServer) ListItemDefs(context.Context, *ListItemDefsRequest) (*ListItemDefsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListItemDefs not implemented")
}
func (UnimplementedRegistryServiceServer) ListAchievementsDefs(context.Context, *ListAchievementsDefsRequest) (*ListAchievementsDefsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAchievementsDefs not implemented")
}
...
func _RegistryService_DeleteItemDef_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteItemDefRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistryServiceServer).DeleteItemDef(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegistryService_DeleteItemDef_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistryServiceServer).DeleteItemDef(ctx, req.(*DeleteItemDefRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RegistryService_ListItemDefs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListItemDefsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistryServiceServer).ListItemDefs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegistryService_ListItemDefs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistryServiceServer).ListItemDefs(ctx, req.(*ListItemDefsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RegistryService_ListAchievementsDefs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAchievementsDefsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistryServiceServer).ListAchievementsDefs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegistryService_ListAchievementsDefs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistryServiceServer).ListAchievementsDefs(ctx, req.(*ListAchievementsDefsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RegistryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteItemDef",
			Handler:    _RegistryService_DeleteItemDef_Handler,
		},
		{
		...
		{
			MethodName: "ListAchievementsDefs",
			Handler:    _RegistryService_ListAchievementsDefs_Handler,
		},
	},
