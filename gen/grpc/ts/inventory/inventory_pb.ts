...
export interface GenerateRequest {
    ...
    holdTill: bigint;
    /**
     * @generated from protobuf field: optional string source_item_def_id = 6
     */
    ...
    description?: string;
    /**
     * @generated from protobuf field: optional string icon_url = 10
     */
    iconUrl?: string;
    /**
     * @generated from protobuf field: optional string app_files = 11
     */
    appFiles?: string;
    /**
...
class GenerateRequest$Type extends MessageType<GenerateRequest> {
    constructor() {
        super("inventory.v1.GenerateRequest", [
            ...
            { no: 6, name: "source_item_def_id", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 7, name: "rarity", kind: "enum", opt: true, T: () => ["common.v1.Rarity", Rarity] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 hold_till */ 5:
                    message.holdTill = reader.int64().toBigInt();
                    break;
                case /* optional string source_item_def_id */ 6:
                ...
                case /* optional string description */ 9:
                    message.description = reader.string();
                    break;
                case /* optional string icon_url */ 10:
                    message.iconUrl = reader.string();
                    break;
                case /* optional string app_files */ 11:
                    message.appFiles = reader.string();
                    break;
    ...
    internalBinaryWrite(message: GenerateRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional string source_item_def_id = 6; */
        if (message.sourceItemDefId !== undefined)
            writer.tag(6, WireType.LengthDelimited).string(message.sourceItemDefId);
        /* optional common.v1.Rarity rarity = 7; */
        if (message.rarity !== undefined)
            writer.tag(7, WireType.Varint).int32(message.rarity);
        ...
        if (message.appFiles !== undefined)
            writer.tag(11, WireType.LengthDelimited).string(message.appFiles);
