 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.registry.v1.DeleteItemDefRequest,
 *   !proto.registry.v1.DeleteItemDefResponse>}
 */
const methodDescriptor_RegistryService_DeleteItemDef = new grpc.web.MethodDescriptor(
  '/registry.v1.RegistryService/DeleteItemDef',
  grpc.web.MethodType.UNARY,
  proto.registry.v1.DeleteItemDefRequest,
  proto.registry.v1.DeleteItemDefResponse,
  /**
   * @param {!proto.registry.v1.DeleteItemDefRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.registry.v1.DeleteItemDefResponse.deserializeBinary
);


/**
 * @param {!proto.registry.v1.DeleteItemDefRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.registry.v1.DeleteItemDefResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.registry.v1.DeleteItemDefResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.registry.v1.RegistryServiceClient.prototype.deleteItemDef =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/registry.v1.RegistryService/DeleteItemDef',
      request,
      metadata || {},
      methodDescriptor_RegistryService_DeleteItemDef,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.registry.v1.DeleteItemDefResponse>}
 *     Promise that resolves to the response
 */
proto.registry.v1.RegistryServicePromiseClient.prototype.deleteItemDef =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/registry.v1.RegistryService/DeleteItemDef',
      request,
