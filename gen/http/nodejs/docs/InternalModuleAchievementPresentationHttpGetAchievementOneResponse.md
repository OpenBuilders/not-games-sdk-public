# InternalModuleAchievementPresentationHttpGetAchievementOneResponse
...
```typescript
import { InternalModuleAchievementPresentationHttpGetAchievementOneResponse } from 'notgamessdkpublic';
