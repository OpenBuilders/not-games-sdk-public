# InternalModuleAchievementPresentationHttpCreateAchievementOneResponse
...
```typescript
import { InternalModuleAchievementPresentationHttpCreateAchievementOneResponse } from 'notgamessdkpublic';
