# InternalModuleRegistryPresentationAchievementHttpAchievementDefOneResponse
...
```typescript
import { InternalModuleRegistryPresentationAchievementHttpAchievementDefOneResponse } from 'notgamessdkpublic';
