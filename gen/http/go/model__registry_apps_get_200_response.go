...
type RegistryAppsGet200Response struct {
	Data *HttpListAppResponse `json:"data,omitempty"`
...
// SetData gets a reference to the given HttpListAppResponse and assigns it to the Data field.
