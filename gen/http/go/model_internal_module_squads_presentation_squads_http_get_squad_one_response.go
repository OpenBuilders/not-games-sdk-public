...
// GetOwnerAccountId returns the OwnerAccountId field value if set, zero value otherwise.
func (o *InternalModuleSquadsPresentationSquadsHttpGetSquadOneResponse) GetOwnerAccountId() int32 {
	if o == nil || IsNil(o.OwnerAccountId) {
		var ret int32
		return ret
	}
...
// SetOwnerAccountId gets a reference to the given int32 and assigns it to the OwnerAccountId field.
...
func (o InternalModuleSquadsPresentationSquadsHttpGetSquadOneResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OwnerAccountId) {
		toSerialize["owner_account_id"] = o.OwnerAccountId
	}
	if !IsNil(o.Prefix) {
