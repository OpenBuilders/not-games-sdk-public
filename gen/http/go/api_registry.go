...
type ApiRegistryAppGetRequest struct {
	ctx context.Context
	ApiService *RegistryAPIService
	appId *string
}
...
// app_id
func (r ApiRegistryAppGetRequest) AppId(appId string) ApiRegistryAppGetRequest {
	r.appId = &appId
	return r
}

func (r ApiRegistryAppGetRequest) Execute() (*RegistryAppGet200Response, *http.Response, error) {
	return r.ApiService.RegistryAppGetExecute(r)
}

/*
RegistryAppGet Get app

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRegistryAppGetRequest
*/
func (a *RegistryAPIService) RegistryAppGet(ctx context.Context) ApiRegistryAppGetRequest {
	return ApiRegistryAppGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return RegistryAppGet200Response
func (a *RegistryAPIService) RegistryAppGetExecute(r ApiRegistryAppGetRequest) (*RegistryAppGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RegistryAppGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RegistryAPIService.RegistryAppGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/registry/app"
...
func (r ApiRegistryItemsGetRequest) Collection(collection string) ApiRegistryItemsGetRequest {
	r.collection = &collection
	return r
}

// Filter by name
func (r ApiRegistryItemsGetRequest) Name(name string) ApiRegistryItemsGetRequest {
	r.name = &name
	return r
}

// Filter by rarity
func (r ApiRegistryItemsGetRequest) Rarity(rarity string) ApiRegistryItemsGetRequest {
	r.rarity = &rarity
	return r
}

// Filter by type
func (r ApiRegistryItemsGetRequest) Type_(type_ string) ApiRegistryItemsGetRequest {
	r.type_ = &type_
	return r
}

// Filter by display type
func (r ApiRegistryItemsGetRequest) DisplayType(displayType string) ApiRegistryItemsGetRequest {
	r.displayType = &displayType
	return r
}

// Filter by hidden status
func (r ApiRegistryItemsGetRequest) Hidden(hidden bool) ApiRegistryItemsGetRequest {
	r.hidden = &hidden
	return r
}

// Filter by game only status
func (r ApiRegistryItemsGetRequest) GameOnly(gameOnly bool) ApiRegistryItemsGetRequest {
	r.gameOnly = &gameOnly
	return r
}

// Filter by store hidden status
func (r ApiRegistryItemsGetRequest) StoreHidden(storeHidden bool) ApiRegistryItemsGetRequest {
	r.storeHidden = &storeHidden
	return r
}

// Filter by tradable status
func (r ApiRegistryItemsGetRequest) Tradable(tradable bool) ApiRegistryItemsGetRequest {
	r.tradable = &tradable
	return r
}

// Filter by supply
func (r ApiRegistryItemsGetRequest) Supply(supply int32) ApiRegistryItemsGetRequest {
	r.supply = &supply
	return r
}

// Comma-separated sort fields
func (r ApiRegistryItemsGetRequest) SortFields(sortFields string) ApiRegistryItemsGetRequest {
	r.sortFields = &sortFields
	return r
}

// Comma-separated sort directions
func (r ApiRegistryItemsGetRequest) Directions(directions string) ApiRegistryItemsGetRequest {
	r.directions = &directions
	return r
}

func (r ApiRegistryItemsGetRequest) Execute() (*ApiV1MarketItemDefGet200Response, *http.Response, error) {
...
func (a *RegistryAPIService) RegistryItemsGetExecute(r ApiRegistryItemsGetRequest) (*ApiV1MarketItemDefGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.rarity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "rarity", r.rarity, "", "")
	}
	if r.type_ != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "type", r.type_, "", "")
	}
	if r.displayType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "display_type", r.displayType, "", "")
	}
	if r.hidden != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hidden", r.hidden, "", "")
	}
	if r.gameOnly != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "game_only", r.gameOnly, "", "")
	}
	if r.storeHidden != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "store_hidden", r.storeHidden, "", "")
	}
	if r.tradable != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tradable", r.tradable, "", "")
	}
	if r.supply != nil {
