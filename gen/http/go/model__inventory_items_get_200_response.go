...
// checks if the InventoryItemsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InventoryItemsGet200Response{}

// InventoryItemsGet200Response struct for InventoryItemsGet200Response
type InventoryItemsGet200Response struct {
...
func NewInventoryItemsGet200Response() *InventoryItemsGet200Response {
	this := InventoryItemsGet200Response{}
	return &this
}
...
func (o InventoryItemsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o InventoryItemsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableInventoryItemsGet200Response struct {
	value *InventoryItemsGet200Response
	isSet bool
}

func (v NullableInventoryItemsGet200Response) Get() *InventoryItemsGet200Response {
	return v.value
}

func (v *NullableInventoryItemsGet200Response) Set(val *InventoryItemsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryItemsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryItemsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryItemsGet200Response(val *InventoryItemsGet200Response) *NullableInventoryItemsGet200Response {
	return &NullableInventoryItemsGet200Response{value: val, isSet: true}
}

func (v NullableInventoryItemsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryItemsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
